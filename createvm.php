<html>
   ...
   <body >
      ...
      <div align = "center">
         <div style = "width:500px; border: solid 1px #333333; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "vmpage.php" method = "post">
                  ...
                  <label>SELECT OS :       </label><select name = "dropdown"><option value = "Linux"class = "box" >Linux</option>
          ...
          <label>CPU Count :</label><select name = "dropdown"><option value = "1cpu"class = "box" >1 vCPU</option>
         ...
         </select><br><br> <label>RAM Size :</label><select name = "dropdown"><option value = "1Gb"class = "box" >1 GB</option>
          ...
          <label>Storage:</label><select name = "dropdown"><option value = "4gb"class = "box" >4 GB</option>
